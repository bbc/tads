...
For various reasons there is a need for transparency and clarity about the rationale for changes made to the TADS API.
...
* Good, because it matches our existing TAMS ways of working
